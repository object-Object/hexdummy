...
import hexdoc_hexdummy

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexDummyPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexDummyModPlugin(branch=branch)


class HexDummyModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexdummy"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexdummy, "_templates"

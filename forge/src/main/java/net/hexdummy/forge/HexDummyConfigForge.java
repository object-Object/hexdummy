...
public class HexDummyConfigForge {
    ...
    public static void init() {
        ...
        HexDummyConfig.setCommon(config.getLeft());
        HexDummyConfig.setClient(clientConfig.getLeft());
        HexDummyConfig.setServer(serverConfig.getLeft());
    ...
    public static class Common implements HexDummyConfig.CommonConfigAccess {
        public Common(ForgeConfigSpec.Builder builder) {

        }
    }

    public static class Client implements HexDummyConfig.ClientConfigAccess {
        public Client(ForgeConfigSpec.Builder builder) {

        }
    }

    public static class Server implements HexDummyConfig.ServerConfigAccess {
        // costs of actions
        private static ForgeConfigSpec.DoubleValue congratsCost;
        private static ForgeConfigSpec.DoubleValue signumCost;

        public Server(ForgeConfigSpec.Builder builder) {
            builder.translation("text.autoconfig.hexdummy.option.server.costs").push("costs");

            congratsCost = builder.translation("text.autoconfig.hexdummy.option.server.costs.congratsCost").defineInRange("congratsCost", DEFAULT_CONGRATS_COST, DEF_MIN_COST, DEF_MAX_COST);
            signumCost = builder.translation("text.autoconfig.hexdummy.option.server.costs.signumCost").defineInRange("signumCost", DEFAULT_SIGNUM_COST, DEF_MIN_COST, DEF_MAX_COST);
